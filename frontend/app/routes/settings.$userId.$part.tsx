      ...
      <div className="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0">
        ...
        <div className="flex-1 lg:max-w-2xl">
          <Form form={form}>
            ...
            <div className="space-y-6" hidden={part !== "" && part !== "personal"}>
              <div>
              ...
              <FormField className="flex flex-col" field={fields.dateOfBirth}>
                ...
                <FormDatePicker  fromDate={addYears(new Date(), -150)} toDate={new Date()} />
                <FormMessage />
              </FormField>
              ...
              >
                ...
                <FormDatePicker fromDate={new Date()} toDate={addYears(new Date(), 50)}/>
                <FormMessage />
              </FormField>
            </div>
            ...
            <div className="space-y-6" hidden={part !== "address"}>
              <div>
                <h3 id='adresa' className="text-lg font-medium">Adresa</h3>
                <p className="text-sm text-muted-foreground">
            ...
            <div className={"space-y-6"} hidden={part !== "contact"}>
              <div>
                <h3 id='kontakt' className="text-lg font-medium">Kontakt</h3>
                <p className="text-sm text-muted-foreground">
                  Update your account settings. Set your preferred language and
                  timezone.
                </p>
