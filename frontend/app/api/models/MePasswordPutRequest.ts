 ...
 * 
 * @export
 * @interface MePasswordPutRequest
 */
export interface MePasswordPutRequest {
    /**
     * The new password
     * @type {string}
     * @memberof MePasswordPutRequest
     */
    password?: string;
}

/**
 * Check if a given object implements the MePasswordPutRequest interface.
 */
export function instanceOfMePasswordPutRequest(value: object): value is MePasswordPutRequest {
    return true;
}

export function MePasswordPutRequestFromJSON(json: any): MePasswordPutRequest {
    return MePasswordPutRequestFromJSONTyped(json, false);
}

export function MePasswordPutRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): MePasswordPutRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function MePasswordPutRequestToJSON(value?: MePasswordPutRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
