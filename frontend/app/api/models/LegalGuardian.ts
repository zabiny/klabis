...
/**
 * Check if a given object implements the LegalGuardian interface.
 */
export function instanceOfLegalGuardian(value: object): value is LegalGuardian {
...
export function LegalGuardianFromJSON(json: any): LegalGuardian {
    return LegalGuardianFromJSONTyped(json, false);
}

export function LegalGuardianFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegalGuardian {
    if (json == null) {
        return json;
    }
    return {
...
export function LegalGuardianToJSON(value?: LegalGuardian | null): any {
    if (value == null) {
        return value;
    }
    return {
