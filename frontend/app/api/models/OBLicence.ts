 ...
 * @interface OBLicence
 */
export interface OBLicence {
    /**
     * License number of the club member
     * @type {string}
     * @memberof OBLicence
     */
    licence: OBLicenceLicence;
}
...
export type OBLicenceLicence = typeof OBLicenceLicence[keyof typeof OBLicenceLicence];


/**
 * Check if a given object implements the OBLicence interface.
 */
export function instanceOfOBLicence(value: object): value is OBLicence {
    if (!('licence' in value) || value['licence'] === undefined) return false;
    return true;
}

export function OBLicenceFromJSON(json: any): OBLicence {
    return OBLicenceFromJSONTyped(json, false);
}

export function OBLicenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): OBLicence {
    if (json == null) {
        return json;
    }
    return {
...
export function OBLicenceToJSON(value?: OBLicence | null): any {
    if (value == null) {
        return value;
    }
    return {
