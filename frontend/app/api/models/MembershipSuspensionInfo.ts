...
export interface MembershipSuspensionInfo {
     ...
     * @memberof MembershipSuspensionInfo
     */
    details: SuspendMembershipBlockers;
}

/**
 * Check if a given object implements the MembershipSuspensionInfo interface.
 */
export function instanceOfMembershipSuspensionInfo(value: object): value is MembershipSuspensionInfo {
    if (!('isSuspended' in value) || value['isSuspended'] === undefined) return false;
    if (!('canSuspend' in value) || value['canSuspend'] === undefined) return false;
    if (!('details' in value) || value['details'] === undefined) return false;
    return true;
}

export function MembershipSuspensionInfoFromJSON(json: any): MembershipSuspensionInfo {
    return MembershipSuspensionInfoFromJSONTyped(json, false);
}

export function MembershipSuspensionInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipSuspensionInfo {
    if (json == null) {
        return json;
    }
    return {
        ...
        'details': SuspendMembershipBlockersFromJSON(json['details']),
    };
}

export function MembershipSuspensionInfoToJSON(value?: MembershipSuspensionInfo | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'canSuspend': value['canSuspend'],
        'details': SuspendMembershipBlockersToJSON(value['details']),
    };
}
