...
import type { SuspendMembershipBlockersFinance } from './SuspendMembershipBlockersFinance';
import {
    SuspendMembershipBlockersFinanceFromJSON,
    SuspendMembershipBlockersFinanceFromJSONTyped,
    SuspendMembershipBlockersFinanceToJSON,
} from './SuspendMembershipBlockersFinance';

/**
 * describes conditions which may prevent membership suspension and their actual status
 * @export
 * @interface SuspendMembershipBlockers
 */
export interface SuspendMembershipBlockers {
    /**
     * 
     * @type {SuspendMembershipBlockersFinance}
     * @memberof SuspendMembershipBlockers
     */
    finance: SuspendMembershipBlockersFinance;
}

/**
 * Check if a given object implements the SuspendMembershipBlockers interface.
 */
export function instanceOfSuspendMembershipBlockers(value: object): value is SuspendMembershipBlockers {
    if (!('finance' in value) || value['finance'] === undefined) return false;
    return true;
}

export function SuspendMembershipBlockersFromJSON(json: any): SuspendMembershipBlockers {
    return SuspendMembershipBlockersFromJSONTyped(json, false);
}

export function SuspendMembershipBlockersFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuspendMembershipBlockers {
    if (json == null) {
        return json;
    }
    return {
        
        'finance': SuspendMembershipBlockersFinanceFromJSON(json['finance']),
    };
}

export function SuspendMembershipBlockersToJSON(value?: SuspendMembershipBlockers | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'finance': SuspendMembershipBlockersFinanceToJSON(value['finance']),
    };
}
