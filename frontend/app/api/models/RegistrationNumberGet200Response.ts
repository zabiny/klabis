 ...
 * 
 * @export
 * @interface RegistrationNumberGet200Response
 */
export interface RegistrationNumberGet200Response {
    /**
     * ORIS registration number
     * @type {string}
     * @memberof RegistrationNumberGet200Response
     */
    suggestedRegistrationNumber: string;
}

/**
 * Check if a given object implements the RegistrationNumberGet200Response interface.
 */
export function instanceOfRegistrationNumberGet200Response(value: object): value is RegistrationNumberGet200Response {
    if (!('suggestedRegistrationNumber' in value) || value['suggestedRegistrationNumber'] === undefined) return false;
    return true;
}

export function RegistrationNumberGet200ResponseFromJSON(json: any): RegistrationNumberGet200Response {
    return RegistrationNumberGet200ResponseFromJSONTyped(json, false);
}

export function RegistrationNumberGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistrationNumberGet200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'suggestedRegistrationNumber': json['suggestedRegistrationNumber'],
    };
}

export function RegistrationNumberGet200ResponseToJSON(value?: RegistrationNumberGet200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'suggestedRegistrationNumber': value['suggestedRegistrationNumber'],
    };
}
