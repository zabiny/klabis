 ...
 * 
 * @export
 * @interface RefereeLicence
 */
export interface RefereeLicence {
    /**
     * referee license number of the club member
     * @type {string}
     * @memberof RefereeLicence
     */
    licence: RefereeLicenceLicence;
    /**
 ...
 * @export
 */
export const RefereeLicenceLicence = {
    R1: 'R1',
    R2: 'R2',
    R3: 'R3'
} as const;
export type RefereeLicenceLicence = typeof RefereeLicenceLicence[keyof typeof RefereeLicenceLicence];


/**
 * Check if a given object implements the RefereeLicence interface.
 */
export function instanceOfRefereeLicence(value: object): value is RefereeLicence {
    if (!('licence' in value) || value['licence'] === undefined) return false;
    if (!('expiryDate' in value) || value['expiryDate'] === undefined) return false;
    return true;
}

export function RefereeLicenceFromJSON(json: any): RefereeLicence {
    return RefereeLicenceFromJSONTyped(json, false);
}

export function RefereeLicenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefereeLicence {
    if (json == null) {
        return json;
    }
    return {
...
export function RefereeLicenceToJSON(value?: RefereeLicence | null): any {
    if (value == null) {
        return value;
    }
    return {
