...
import type { MembersListItemsInner } from './MembersListItemsInner';
import {
    MembersListItemsInnerFromJSON,
    MembersListItemsInnerFromJSONTyped,
    MembersListItemsInnerToJSON,
} from './MembersListItemsInner';
...
export interface MembersList {
    /**
     * 
     * @type {Array<MembersListItemsInner>}
     * @memberof MembersList
     */
    items: Array<MembersListItemsInner>;
}

/**
 * Check if a given object implements the MembersList interface.
 */
export function instanceOfMembersList(value: object): value is MembersList {
    if (!('items' in value) || value['items'] === undefined) return false;
    return true;
}

export function MembersListFromJSON(json: any): MembersList {
    return MembersListFromJSONTyped(json, false);
}

export function MembersListFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembersList {
    if (json == null) {
        return json;
    }
    return {
        
        'items': ((json['items'] as Array<any>).map(MembersListItemsInnerFromJSON)),
    };
}

export function MembersListToJSON(value?: MembersList | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'items': ((value['items'] as Array<any>).map(MembersListItemsInnerToJSON)),
    };
}
