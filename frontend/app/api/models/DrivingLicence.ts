...
export type DrivingLicence = typeof DrivingLicence[keyof typeof DrivingLicence];


export function instanceOfDrivingLicence(value: any): boolean {
    for (const key in DrivingLicence) {
        if (Object.prototype.hasOwnProperty.call(DrivingLicence, key)) {
            if (DrivingLicence[key as keyof typeof DrivingLicence] === value) {
                return true;
            }
        }
    }
...
export function DrivingLicenceFromJSON(json: any): DrivingLicence {
    return DrivingLicenceFromJSONTyped(json, false);
}

export function DrivingLicenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): DrivingLicence {
    return json as DrivingLicence;
}

export function DrivingLicenceToJSON(value?: DrivingLicence | null): any {
    return value as any;
}
