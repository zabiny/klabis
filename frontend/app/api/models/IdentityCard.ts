...
/**
 * Check if a given object implements the IdentityCard interface.
 */
export function instanceOfIdentityCard(value: object): value is IdentityCard {
    return true;
}

export function IdentityCardFromJSON(json: any): IdentityCard {
    return IdentityCardFromJSONTyped(json, false);
}

export function IdentityCardFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentityCard {
    if (json == null) {
        return json;
    }
    return {
...
export function IdentityCardToJSON(value?: IdentityCard | null): any {
    if (value == null) {
        return value;
    }
    return {
