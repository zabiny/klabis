                    ...
                    <MemberDetailsCard title="Licence">
                        <div className="space-y-0">
                            ...
                            {member.licences.referee && (
                                <>
                                    <MemberDetailsField label="Rozhodčí licence"
                                                        value={member.licences.referee.licence}/>
                                    <MemberDetailsField
                                        label="Platnost do"
                            ...
                            {member.licences.trainer && (
                                <>
                                    <MemberDetailsField label="Trenérská licence"
                                                        value={member.licences.trainer.licence}/>
                                    <MemberDetailsField
                                        label="Platnost do"
