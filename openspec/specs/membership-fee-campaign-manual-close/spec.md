# Capability: Membership Fee Campaign Manual Close

## Purpose

Allows membership administrators to immediately close an active fee selection campaign without waiting for the automatic nightly processing. The manual close triggers the same processing as the automatic end-of-deadline flow.
