...
TBD - created by archiving change enable-https-8443. Update Purpose after archive.
...
- **WHEN** developer runs certificate generation script
- **THEN** script generates keystore file at development keystore location
...
- **THEN** test keystore is available at test keystore location
...
- **THEN** HTTP client is configured to trust test certificate
...
- **WHEN** developer opens HTTP client configuration
