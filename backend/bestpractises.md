...
- `_links` obsahuje relace na ostatni objekty (provazani mezi ruznymi GET resources). `_templates` obsahuje AKCE (PUT,
  POST, DELETE) ktere lze v danem miste provest. To znamena ze `_templates` ma vyznam jak v Item resource, tak i
