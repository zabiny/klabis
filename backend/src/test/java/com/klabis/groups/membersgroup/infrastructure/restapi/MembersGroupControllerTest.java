...
import com.klabis.groups.membersgroup.application.MembersGroupManagementPort;
import com.klabis.groups.membersgroup.application.PendingInvitationView;
...
@DisplayName("MembersGroupController API tests")
@WebMvcTest(controllers = {MembersGroupController.class, PendingInvitationsController.class, MembersGroupExceptionHandler.class})
@Import({EncryptionConfiguration.class, HalFormsSupport.class})
class MembersGroupControllerTest {
    ...
    private static final MembersGroupId GROUP_ID = new MembersGroupId(GROUP_UUID);
    ...
    @MockitoBean
    private MembersGroupManagementPort membersGroupManagementService;
    ...
    private MembersGroup buildGroup(UUID groupUuid, String name, String ownerUuidStr) {
        MemberId owner = new MemberId(UUID.fromString(ownerUuidStr));
        return MembersGroup.reconstruct(
                new MembersGroupId(groupUuid), name, Set.of(owner), Set.of(), Set.of(), null);
    }
    ...
    class CreateGroupTests {
        ...
        void shouldCreateGroupAndReturn201() throws Exception {
            MembersGroup created = buildGroup(GROUP_UUID, "Trail Runners", MEMBER_ID);
    ...
    class RenameGroupTests {
        ...
        void shouldRenameGroupAndReturn204() throws Exception {
            ...
            when(membersGroupManagementService.renameGroup(any(MembersGroupId.class), any(String.class), any(MemberId.class)))
    ...
    class DeleteGroupTests {
        ...
        void shouldReturn403WhenNotOwner() throws Exception {
            MemberId notOwner = new MemberId(UUID.fromString(OTHER_MEMBER_ID));
            doThrow(new GroupOwnershipRequiredException(notOwner, GROUP_ID))
                    .when(membersGroupManagementService).deleteGroup(any(MembersGroupId.class), any(MemberId.class));
    ...
    class RemoveMemberTests {
        ...
        void shouldReturn403WhenNotOwner() throws Exception {
            MemberId notOwner = new MemberId(UUID.fromString(OTHER_MEMBER_ID));
            doThrow(new GroupOwnershipRequiredException(notOwner, GROUP_ID))
                    .when(membersGroupManagementService).removeMember(any(MembersGroupId.class), any(MemberId.class), any(MemberId.class));
    ...
    class AddOwnerTests {
        ...
        void shouldReturn403WhenNotOwner() throws Exception {
            MemberId notOwner = new MemberId(UUID.fromString(OTHER_MEMBER_ID));
            doThrow(new GroupOwnershipRequiredException(notOwner, GROUP_ID))
                    .when(membersGroupManagementService).addOwner(any(MembersGroupId.class), any(MemberId.class), any(MemberId.class));
    ...
    class RemoveOwnerTests {
        ...
        void shouldReturn403WhenNotOwner() throws Exception {
            MemberId notOwner = new MemberId(UUID.fromString(OTHER_MEMBER_ID));
            doThrow(new GroupOwnershipRequiredException(notOwner, GROUP_ID))
                    .when(membersGroupManagementService).removeOwner(any(MembersGroupId.class), any(MemberId.class), any(MemberId.class));
    ...
    class InviteMemberTests {
        ...
        void shouldReturn403WhenNotOwner() throws Exception {
            MemberId notOwner = new MemberId(UUID.fromString(OTHER_MEMBER_ID));
            doThrow(new GroupOwnershipRequiredException(notOwner, GROUP_ID))
                    .when(membersGroupManagementService).inviteMember(any(MembersGroupId.class), any(MemberId.class), any(MemberId.class));
