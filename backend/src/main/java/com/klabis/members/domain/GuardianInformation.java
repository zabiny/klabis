...
public final class GuardianInformation {
    ...
    public GuardianInformation(String firstName, String lastName, String relationship, String email, String phone) {
        this(firstName, lastName, relationship, EmailAddress.of(email), PhoneNumber.of(phone));
    }
