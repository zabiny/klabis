...
@Service
class DepositService implements DepositPort {

    private final MemberAccountRepository memberAccountRepository;

    DepositService(MemberAccountRepository memberAccountRepository) {
    ...
    public Transaction deposit(DepositCommand command) {
        ...
        Transaction tx = account.deposit(amount, command.note(), command.occurredAt(),
