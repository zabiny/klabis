...
@Component
class AdminEditMemberResourceProcessor implements RepresentationModelProcessor<EntityModel<MembersApiResponse>> {

    private final KlabisSecurityService securityService;

    AdminEditMemberResourceProcessor(KlabisSecurityService securityService) {
