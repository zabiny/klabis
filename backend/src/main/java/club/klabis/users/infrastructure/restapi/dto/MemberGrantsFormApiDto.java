...
public class MemberGrantsFormApiDto extends RepresentationModel<MemberGrantsFormApiDto> {
    ...
    public MemberGrantsFormApiDto addGrantsItem(club.klabis.users.infrastructure.restapi.dto.GlobalGrantsApiDto grantsItem) {
        if (this.grants == null) {
    ...
    public void setGrants(List<club.klabis.users.infrastructure.restapi.dto.GlobalGrantsApiDto> grants) {
        this.grants = grants;
    }
    ...
    public static class Builder {
        ...
        public Builder grants(List<club.klabis.users.infrastructure.restapi.dto.GlobalGrantsApiDto> grants) {
